...
class ConfirmationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    fun postData(){
        ...
        jsonObject.put("location",userData.location.toString())
        jsonObject.put("description",userData.description.toString())
        jsonObject.put("email",userData.email.toString())
        jsonObject.put("no_telp",userData.no_telp.toString())
